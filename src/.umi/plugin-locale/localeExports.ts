...
import {
  ...
  IntlShape,
  MessageDescriptor,
} from 'D:/Work/Cuban Engineers/Recruitment process/Technical test/Application/instashare/node_modules/react-intl';
import { ApplyPluginsType } from 'umi';
import { event, LANG_CHANGE_EVENT } from './locale';
// @ts-ignore
import warning from 'D:/Work/Cuban Engineers/Recruitment process/Technical test/Application/instashare/node_modules/warning/warning.js';
...
import lang_enUS0 from "D:/Work/Cuban Engineers/Recruitment process/Technical test/Application/instashare/src/locales/en-US.ts";
import esES0 from 'antd/es/locale/es_ES';
import lang_esES0 from "D:/Work/Cuban Engineers/Recruitment process/Technical test/Application/instashare/src/locales/es-ES.ts";
...
export const getIntl = (locale?: string, changeIntl?: boolean) => {
  ...
  // 使用 zh-CN
  if (localeInfo["en-EN"]) return createIntl(localeInfo["en-EN"]);
