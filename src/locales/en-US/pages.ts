export default {
  ...
  'pages.login.confirmPassword.placeholder': 'Confirm your password',
  ...
  'pages.login.changePassword': 'Change password',
  ...
  'pages.profile.pageTitle': 'User profile',
  'pages.403.subtitle.accessDenied': 'We sorry, you do not have permissions to access this page.',
};
